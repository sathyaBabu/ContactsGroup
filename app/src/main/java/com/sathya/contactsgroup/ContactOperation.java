...
public class ContactOperation {
	Context con;
	private String GroupTitle = "Android Developers Guild \n - Sathya";
	...
	void addPhoto(ArrayList<ContentProviderOperation> ops){
		...
		cv.put(Photo.PHOTO,ImageContact(R.drawable.blueeyes));
	...
	private String getGroupId()
	{
		...
		if (GroupId == null)
		{
			...
			opsGroup.add(ContentProviderOperation.newInsert(ContactsContract.Groups.CONTENT_URI)
					...
					.withValue(ContactsContract.Groups.NOTES, "Very valuable Group - My Notes")
